...
[![Version](https://img.shields.io/npm/v/@f1stnpm3/optio-error-asperiores.svg?style=for-the-badge)](https://www.npmjs.com/package/@f1stnpm3/optio-error-asperiores)
[![npm](https://img.shields.io/npm/dt/@f1stnpm3/optio-error-asperiores.svg?style=for-the-badge)](https://www.npmjs.com/package/@f1stnpm3/optio-error-asperiores)
...
**Try it out for yourself on [Expo Snack](https://snack.expo.dev/@nuumi/@f1stnpm3/optio-error-asperiores-demo)!** Make sure to run it on a mobile to see it working properly.
...
```bash
npm install @f1stnpm3/optio-error-asperiores
```

or

```bash
yarn add @f1stnpm3/optio-error-asperiores
```
...
```jsx
import { TimerPickerModal } from "@f1stnpm3/optio-error-asperiores";
...
```jsx
import { TimerPicker } from "@f1stnpm3/optio-error-asperiores";
import { LinearGradient } from "expo-linear-gradient"; // or `import LinearGradient from "react-native-linear-gradient"`
